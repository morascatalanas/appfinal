  ...
  <div class="accordion" role="tablist">
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-1 > SPORTSMANSHIP </b-button>
      </b-card-header>
      <b-collapse id="accordion-1" visible accordion="my-accordion" role="tabpanel">
        <b-card-body>
          <b-card-text>  The common interest that members of the Association share is to inspire
                      ...
                      technical soccer background, expertise, accomplishments or standing. </b-card-text>
        </b-card-body>
      </b-collapse>
    </b-card>
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-2 > FIFA FIELD REGULATIONS</b-button>
      </b-card-header>
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-3 >EQUIPMENT</b-button>
      </b-card-header>
      <b-collapse id="accordion-3" accordion="my-accordion" role="tabpanel">
        <b-card-body>
          <b-card-text>We will abide by and accept equipment standards as defined by FIFA, USSF and USYSA.</b-card-text>
        </b-card-body>
      </b-collapse>
    </b-card>
